 ...
 * Special Offers Page
 *
 * Shows all products with special offers
 * Similar to discounts page but filtered by special offers
 */
...
export default function OffersPage() {
  ...
  // Fetch products with special offers
    ...
    <AppShell>
      <div className="flex-1 min-w-0 bg-white rounded-2xl px-6 py-6 mx-2 my-2">
        ...
        <section>
          ...
          >
            {isRTL ? 'جميع المنتجات بعروض خاصة' : 'All Products with Special Offers'}
          </h3>
          ...
          {!productsLoading && (!products || products.length === 0) && (
            <div className="text-center py-12">
              <p className="text-gray-500">{isRTL ? 'لا توجد عروض خاصة حالياً' : 'No special offers available'}</p>
            </div>
          )}
        </section>
      </div>
