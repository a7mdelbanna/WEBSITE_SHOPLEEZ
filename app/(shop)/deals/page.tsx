...
/**
 * Spotlight Deals Page
 *
 * Shows all spotlight/featured products
 * Similar to discounts and offers pages but filtered by spotlight status
 */
  ...
  return (
    <AppShell>
      <div className="flex-1 min-w-0 bg-white rounded-2xl px-6 py-6 mx-2 my-2">
        ...
        >
          {isRTL ? 'المنتجات المميزة' : 'Spotlight Deals'}
        </h1>
        ...
        <section>
          ...
          >
            {isRTL ? 'جميع المنتجات المميزة' : 'All Featured Products'}
          </h3>
          ...
          {!productsLoading && (!products || products.length === 0) && (
            <div className="text-center py-12">
              <p className="text-gray-500">{isRTL ? 'لا توجد منتجات مميزة حالياً' : 'No featured products available'}</p>
            </div>
          )}
        </section>
      </div>
